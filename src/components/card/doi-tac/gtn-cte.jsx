...
const cards = [
  {
    ...
    desc: 'Ưu tiên lựa chọn gạo có thông tin xuất xứ minh bạch, đảm bảo chất lượng và an toàn thực phẩm.',
  },
  {
    title: 'Chất Lượng Ổn Định',
    desc: 'Gạo ngon, sạch và đồng đều giúp mang đến những bữa cơm đủ đầy cho người nhận.',
  },
  {
    title: 'Giá Phù Hợp Cho Thiện Nguyện',
    desc: 'Tối ưu chi phí để các mạnh thường quân có thể hỗ trợ được nhiều hoàn cảnh hơn.',
  },
  {
    title: 'Cung Ứng Số Lượng Lớn',
    desc: 'Đảm bảo nguồn hàng ổn định cho các chương trình phát quà, cứu trợ và hỗ trợ cộng đồng.',
  },
];

export default function GtnCategories() {
  ...
  return (
    ...
    >
      <PublicContainer className="container-custom mx-auto relative z-10">
        ...
        >
          <SectionTag title="GẠO THIỆN NGUYỆN" />
          ...
          <p className="max-w-2xl mx-auto text-secondary-600 text-sm sm:text-base leading-relaxed">
            Cơm Lành luôn ưu tiên chất lượng, sự minh bạch và tính ổn định nhằm
            mang đến những bữa cơm đủ đầy cho cộng đồng.
          </p>
