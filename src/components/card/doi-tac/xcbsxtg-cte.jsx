...
const cards = [
  {
    title: 'Gạo Lưu Kho Chuyên Dụng',
    desc: 'Cam kết gạo lưu kho ổn định, không đấu trộn, phù hợp cho sản xuất quy mô lớn.',
  },
  {
    title: 'Nguồn Cung Ổn Định',
    desc: 'Đáp ứng linh hoạt từ số lượng nhỏ đến hàng chục tấn mỗi ngày.',
  },
  {
    title: 'Giá Ổn Định Dài Hạn',
    desc: 'Hỗ trợ hợp đồng lâu dài giúp xưởng chủ động chi phí sản xuất.',
  },
  {
    title: 'Hồ Sơ Minh Bạch',
    desc: 'Đầy đủ chứng nhận, hóa đơn và kiểm định chất lượng rõ ràng.',
  },
];

export default function ProcessingFactoryCategories() {
  ...
  return (
    <section
      id="processing-factory-categories-section"
      ref={ref}
    ...
    >
      <PublicContainer className="container-custom mx-auto relative z-10">
        ...
        >
          <SectionTag title="XƯỞNG CHẾ BIẾN & SẢN XUẤT" />
          ...
          <p className="max-w-2xl mx-auto text-secondary-600 text-sm sm:text-base leading-relaxed">
            Cơm Lành mang đến giải pháp nguyên liệu ổn định, phù hợp cho nhiều
            mô hình chế biến và sản xuất từ gạo.
          </p>
