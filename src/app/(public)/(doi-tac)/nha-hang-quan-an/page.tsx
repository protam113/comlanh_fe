...
import RestaurantCategories from '@/components/card/doi-tac/nhqa-cte';
import { CTAButton } from '@/components/cta.button';
import { RestaurantCard } from '@/components/card/doi-tac/nhqa';
      ...
      <PublicContainer className="bg-section-alt mt-4 mx-auto py border-b  border-gray-200">
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-[0.85rem] font-bold text-text-muted uppercase tracking-wider">
            ...
            <span>/</span>
            <span className="text-primary-dark">Nhà Hàng Quán Ăn</span>
          </nav>
        </div>
      </PublicContainer>
