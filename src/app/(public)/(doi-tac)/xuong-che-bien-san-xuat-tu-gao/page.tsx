...
import { ProcessingFactoryCard } from '@/components/card/doi-tac/xcbsxtg';
import ProcessingFactoryCategories from '@/components/card/doi-tac/xcbsxtg-cte';
  ...
  return (
    <div className="pt-16 bg-white min-h-screen">
      ...
      <PublicContainer className="mx-auto py-8 space-y-6">
        <ProcessingFactoryCard />
        <CTAButton />
        <ProcessingFactoryCategories />
